    ...
    <div className="flex flex-col">
      ...
      <main className="flex-1 p-4 sm:p-6 space-y-6">
        <section className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card className="transition-all duration-300 hover:scale-102 hover:shadow-2xl hover:bg-card/80">
          ...
          <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
            {quickLinks.map((link) => (
              <Button
                ...
                asChild
                variant="outline"
                className="justify-start h-14 text-left transition-all duration-300 hover:scale-102 hover:shadow-lg hover:bg-accent"
              >
